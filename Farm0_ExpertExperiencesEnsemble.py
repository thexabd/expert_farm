...
expert_agent1 = PPO.load("Heuristic_Agent")
expert_agent2 = PPO.load("Heuristic_Agent")
...
if __name__ == "__main__":
        ...
        for step in range(0, args.num_steps):
            ...
            with torch.no_grad():
                ...
                if beta_prob < args.beta: 
                    ...
                    action1, logprob1, _, value1 = expert_actions_values(expert_agent1, next_obs)
                    action2, logprob2, _, value2 = expert_actions_values(expert_agent2, next_obs)
                    
                    if value2 > value1:
                        action, logprob, value = action2, logprob2, value2
                    else:
                        action, logprob, value = action1, logprob1, value1
                else:
                    # Obtain the action, log probability of the action, and value estimate from the policy network
    ...
    torch.save(agent, 'EI_Ensemble_PPO.pt')
